...
int main(){
    ...
    cattle.push_back(cow("Becky", 6, cow_purpose::meat));
    cattle.push_back(cow("Libby", 3, cow_purpose::hide));
    cattle.push_back(cow("Betty", 7, cow_purpose::pet));
    cattle.push_back(cow("Terry", 4, cow_purpose::dairy));
